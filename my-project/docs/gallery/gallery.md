...
<!-- 页面标记，用于只在本页应用样式 -->
<div id="gallery-flag" hidden></div>

# Gallery

<!-- 画廊瀑布墙：每个卡片点击跳到同目录的 md -->
<div class="gallery-wall">
<!-- 
  <a class="gallery-card" href="../gallery/g1.md" title="作品 g1">
    <img class="gallery-thumb" src="../gallery/g_img/g1.png" alt="g1" loading="lazy">
    <span class="gallery-caption">作品 g1</span>
  </a>
   -->
  <a class="gallery-card" href="../gallery/g1.md" title="作品 g1">
  <img class="gallery-thumb" src="./g_img/g1.png" alt="g1" loading="lazy">
  <span class="gallery-caption">作品 g1</span>
  </a>
  ...
  <!-- 继续按需添加：
  <a class="gallery-card" href="g4.md">
    <img class="gallery-thumb" src="gallery/g_img/g4.png" alt="g4" loading="lazy">
    <span class="gallery-caption">作品 g4</span>
  </a>
  -->
